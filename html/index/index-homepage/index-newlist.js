			...
			getInfoHtml: function(info){
				...
				if(info){
					...
					infoHtml = '<li class="mui-table-view-cell mui-media app_pl5'
							   ...
							   +content+'"><img class="mui-media-object mui-pull-left" src="'
							   +HOST + info.thumbnailUrl+'" data-onlineUrl="'
							   +HOST + info.thumbnailUrl+'" data-load="1" data-type="news"><div class="mui-media-body"><div class="mui-ellipsis app_f14 app_pt5 app_pb5">'
