...
//			GHUTILS.setUserAgent();
		...
		bindEvent: function() {
			...
			$("#app_filter_btn").on("tap", function() {
				...
				mui.fire(plus.webview.getWebviewById(GHUTILS.PAGESID.ACCDW), "showMenu", {
					show: show
				});
			});
		...
		closeafilter: function() {
			...
			mui.fire(plus.webview.getWebviewById(GHUTILS.PAGESID.ACCDW), "showList");
		},
