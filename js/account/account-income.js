		...
		getIncomeHtml: function(incomes){
			...
			for(var i in incomes){
				...
				for(var j in currdayIncomes){
					...
					if(currdayIncomes[j]){
						html +='<li style="line-height:40px"><span class="mui-pull-right">'+ GHUTILS.formatCurrency(currdayIncomes[j]) +'元</span><span'+style+'>'+ currdayIncomes.date +'</span></li>'
					}
				}
			}
