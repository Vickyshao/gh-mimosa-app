...
//			$("#slider").css({"top": ""+GHUTILS.setTop(44)+"px"})
		...
		getInfoHtml: function(info){
			var _this = this;
			var linkpages = "", content = "", infoHtml = "";
			if(info){
				if(info.url){
				...
				infoHtml = '<div class="'+linkpages+' app_bline" data-content="'+content+'" data-links="' + info.url + '" data-title="' + info.title + '"><li class="mui-table-view-cell mui-media app_pl15"><img class="mui-media-object mui-pull-left" src="' + HOST + info.thumbnailUrl + '"><div class="mui-media-body"><div class="mui-ellipsis app_f14 app_pt5 app_pb5">' + info.title + '</div><p class="mui-h6 mui-ellipsis-2">' + info.summary + '</p></div></li></div>';
			}
			return infoHtml;
		},
...
//					console.log(cmsChannelOid)
		...
		getInformationHtml: function(tradeObj) {
			var linkpages = "", content = "";
			if(tradeObj.url){
				linkpages = "app_link_pages";
			}else{
				if(tradeObj.content){
					linkpages = "app_content";
					content = encodeURIComponent(tradeObj.content)
			...
			var infomationHtml = '<div class="'+linkpages+' app_bline" data-content="'+content+'" data-links="' + tradeObj.url + '" data-title="' + tradeObj.title + '"><li class="mui-table-view-cell mui-media app_pl15"><img class="mui-media-object mui-pull-left" src="' + HOST + tradeObj.thumbnailUrl + '"><div class="mui-media-body"><div class="mui-ellipsis app_f14 app_pt5 app_pb5">' + tradeObj.title + '</div><p class="mui-h6 mui-ellipsis-2">' + tradeObj.summary + '</p></div></li></div>';
