...
//				    }
			...
			//首页签到去投资，检测版本更新
			document.addEventListener("goUpdata", function(e){
...
//				}
		...
		getProdHtml: function(tradeObj){
			...
			var prodHtml = '<div class="app_product_ihbox app_showdetail'+
							...
							_this.switchShowType(tradeObj).interestSec+'%</span></div><p class="app_f14 app_cb3a app_mt8 app_c8">随时取现</p></div><div class="app_product_ihview app_fl mui-col-xs-7 app_pt5 app_pb10 app_f14 app_c4 text-align-right"><span class="app_c8">每万元收益：</span>'+
